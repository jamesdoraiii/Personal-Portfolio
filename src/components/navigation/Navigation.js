...
class Navigation extends React.Component{
        ...
        <Nav style = {styles.nav} className="ml-auto" navbar>
          ...
          <NavItem>
                <NavLink><a href = "https://drive.google.com/file/d/18t6dDIOTouznAvsU_jvbnL_G8uaN0kgB/view?usp=sharing" target = "_blank" style = {styles.navbartext}>Resume</a></NavLink>
          </NavItem>
          <NavItem>
                <NavLink><a href = "https://www.linkedin.com/in/james-dora-2950b3aa" style = {styles.navbartext} target = "_blank">LinkedIn</a></NavLink>
          </NavItem>
        </Nav>
        </Collapse>
        </Navbar>
